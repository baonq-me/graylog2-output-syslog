...
public class GelfMessageJsonEncoder extends MessageToMessageEncoder<GelfMessage> {
    ...
    /**
     * Creates a new instance of this channel handler with the default {@link JsonFactory}.
     */
    ...
    /**
     * Creates a new instance of this channel handler with the given {@link JsonFactory}.
     *
     * @param jsonFactory the Jackson {@link JsonFactory} to use for constructing a GELF message payload
     */
